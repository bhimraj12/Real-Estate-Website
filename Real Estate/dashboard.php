...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="main.php" class="icon-a"><i class="fa fa-users icons"></i> &nbsp;&nbsp;Home</a>
        <a href="support.php" class="icon-a"><i class="fa fa-shopping-bag icons"></i> &nbsp;&nbsp;Contact</a>
        <a href="favourites.php" class="icon-a"><i class="fa fa-tasks icons"></i> &nbsp;&nbsp;Favourites</a>
        <a href="<?php
                if(isset($_SESSION['ID'])){
                echo "./logout.php";
                }else{
